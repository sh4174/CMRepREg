...
//	else if(itksys::SystemTools::Strucmp(name,"BAYESIAN-FRAMEWORK") == 0)
//	{
//		if(itksys::SystemTools::Strucmp(m_CurrentString.c_str(),"ON") == 0)
//			m_PObject->SetBayesianFramework();
//		else if (itksys::SystemTools::Strucmp(m_CurrentString.c_str(),"OFF") == 0)
//			m_PObject->UnsetBayesianFramework();
//		else
...
//	}
    ...
    {
        m_PObject->SetAtlasType(m_CurrentString);
    }
	...
	else if(itksys::SystemTools::Strucmp(name,"ATLAS-NAME") == 0)
	{
		m_PObject->SetAtlasName_fn(m_CurrentString);
	}
	  /******************************************************************************************************************************
	                                                               CHANGE END
	  ******************************************************************************************************************************/
	...
	else if(itksys::SystemTools::Strucmp(name,"SAVE-EVERY-N-ITERS") == 0)
	{
		long n = atol(m_CurrentString.c_str());
		m_PObject->SetSaveEveryNIters(n);
	}
...
::WriteFile()
{
	...
	WriteField<unsigned int>(this, "SAVE-EVERY-N-ITERS", p->GetSaveEveryNIters(), output);
