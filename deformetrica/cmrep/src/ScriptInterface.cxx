...
vtkPolyData* GetBoundaryMeshVTK( GenericMedialModel *xModel );
...
vtkPolyData* MedialPDE::GetBoundaryVTK()
{
  return GetBoundaryMeshVTK( xMedialModel );
}
